...
Auto-install is off by default. shinyelectron does not download anything without explicit consent: either `auto_install: true` here, or a manual `install_nodejs()` call.
:::
