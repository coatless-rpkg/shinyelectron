...
Pins R for the `bundled` and `auto-download` runtime strategies. Nested under `dependencies:`. Ignored otherwise.
...
Pins Python for the `bundled` and `auto-download` runtime strategies. Nested under `dependencies:`. Ignored otherwise.
