...
shinyelectron provides several features beyond the basic export pipeline:
splash screens, system tray integration, native menus, and preloader
configuration. This guide covers each one.

## Splash Screens

The splash screen occupies the window while the backend starts, replacing a
blank screen with useful feedback.
